...
public class BridgeResolutionServiceTests
{
    ...
    {
        Assert.StartsWith("3.4.7", WikidataLibraryInfo.PackageVersion, StringComparison.Ordinal);
        Assert.StartsWith("3.4.7", WikidataReconciler.LibraryVersion, StringComparison.Ordinal);
    }
